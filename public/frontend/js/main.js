(function($) {
    ...
    $('.sliderNav-active').slick({
        ...
        fade: true,
        arrows: true,
        prevArrow: '<button type="button" class="slick-prev"><img src="frontend/img/icon/left_arrow.svg" alt=""></button>',
        nextArrow: '<button type="button" class="slick-next"><img src="frontend/img/icon/right_arrow.svg" alt=""></button>',
