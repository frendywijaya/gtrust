...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <form action="{{ route('admin.staticpage.save', 'servicelearning') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="modal-body">
                        <div class="row mb-3 mt-2 justify-content-center pb-3 border-bottom">
                            <div class="col-lg-12 justify-content-center">
                                ...
                                <input class="form-dynamic" type="hidden" value="learning" name="category">
